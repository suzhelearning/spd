...
class PicoHandFrame:
    """Framework-independent representation of one atomic dual-hand frame."""
...
class PicoHandsInput:
    ...
    def update(
        ...
        *,
        ...
        ``update(left, right, ...)`` is supported for replay/tests; mappings and
        compatible messages use the same PICO hand-field contract.
        """
