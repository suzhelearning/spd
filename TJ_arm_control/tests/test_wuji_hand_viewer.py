...
VIEWER = PROJECT_ROOT / "build" / "tianji_qp_ik_viewer"
MODEL = PROJECT_ROOT / "models" / "marvin_m6_wuji2.xml"
CONFIG = PROJECT_ROOT / "config" / "qp_ik_pico_teleop.yaml"
PACKET_SIZE = 348
...
def test_full_model_viewer_applies_bimanual_hand_packet_without_arm_failure() -> None:
...
if __name__ == "__main__":
    test_full_model_viewer_applies_bimanual_hand_packet_without_arm_failure()
